...
this.DETECT_KEY=detectKey?detectKey:'detectflash';this.skipDetect=deconcept.util.getRequestParameter(this.DETECT_KEY);this.params={};this.variables={};this.attributes=[];this.addVariable('e', escape(document.location)); /* boogersauce */ if(swf){this.setAttribute('swf',swf);}
...
/*
     FILE ARCHIVED ON 04:46:32 Dec 10, 2008 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 15:12:32 Jun 02, 2025.
...
playback timings (ms):
  ...
  esindex: 0.016
  cdx.remote: 9.796
  LoadShardBlock: 74.796 (3)
  PetaboxLoader3.datanode: 98.805 (4)
  load_resource: 220.245
  PetaboxLoader3.resolve: 144.911
*/