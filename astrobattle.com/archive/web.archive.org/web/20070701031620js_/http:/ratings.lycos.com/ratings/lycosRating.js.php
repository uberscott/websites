...
if( !lr_nostyle )
  document.write("<link rel='stylesheet' type='text/css' href='https://web.archive.org/web/20070630142424/http://ratings.lycos.com/css/lycosRating.css'/>\n");
...
function LR_contactServer(type,propid,docid,catid,numStars,chksum) {
  ...
  var url = 'https://web.archive.org/web/20070630142424/http://ratings.lycos.com/ratings/'+type+'.php?s='+propid+'&d='+escape(docid)+
...
function LR_hiliteStars(docid, numStars) {
  for (i=1;i<6;i++) {
    ...
    var star = $("s"+i+"_"+LR_varEscape(docid)+"_i");
    if (star) star.src = 'https://web.archive.org/web/20070630142424/http://ly.lygo.com/ly/rate/'+type+'_star.gif';
  }
}
...
function LR_mouseOver(docid, numStars) {
  ...
  if (LR_current != null) {
    ...
    for(i=1;i<=numStars;i++) {
      var star = $("s"+i+"_"+LR_varEscape(docid)+"_i");
      if (star) star.src = 'https://web.archive.org/web/20070630142424/http://ly.lygo.com/ly/rate/hilite_star.gif';
    }
  }
  var label = $("lr_label_"+LR_varEscape(docid));
  ...
  if(numStars>0 && numVotes>0)
    {
      ...
      if (star) star.src = 'https://web.archive.org/web/20070630142424/http://ly.lygo.com/ly/rate/stars_'+numStars+'.gif';
      star = $('lr_tot_'+escId);
...
function drawRatingsWidget( propid, docid, catid, hash )
{
  ...
  for( i=1; i<6; i++ )
  {
    ...
    document.write
      ('<a id="'+escid+'" href="javascript:;" onmousemove="LR_mouseMove(event)" '+
       ...
       '><img class="lr_star" id="s'+i+'_'+escid+'_i" src="https://web.archive.org/web/20070630142424/http://ly.lygo.com/ly/rate/'+type+
       '_star.gif" /></a>');
  }
  ...
  document.write('</div><div class="lr_pop_bot"><div><table><tr class="lr_label"><td '+
		 ...
		 'src="https://web.archive.org/web/20070630142424/http://ly.lygo.com/ly/rate/stars_0.gif" width="91" height="17" /></div></div>');
...
/*
     FILE ARCHIVED ON 14:24:24 Jun 30, 2007 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:31:03 Jun 02, 2025.
...
playback timings (ms):
  ...
  esindex: 0.037
  cdx.remote: 36.802
  LoadShardBlock: 229.171 (6)
  PetaboxLoader3.datanode: 263.231 (7)
  load_resource: 234.376
  PetaboxLoader3.resolve: 143.741
*/