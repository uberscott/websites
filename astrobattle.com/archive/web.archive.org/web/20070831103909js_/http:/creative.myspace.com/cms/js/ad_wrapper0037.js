...
Advertiser.SDC.DropPixel = function ()
{
   ...
   if (Advertiser.Login.IsLogin())
   {
      ...
      fimpixel = '<img src="https://web.archive.org/web/20070831085731/http://seg.fimserve.com/relay?';
...
function ad_wrapper()
{
	...
	{
		if(testmode)
			frameURL = "https://web.archive.org/web/20070831085731/http://detst.myspace.com/html.ng/site=myspace&position="+pos+"&page="+page+"&rand="+rand+friendID+AdTopicID+"&acnt="+oas_helper.adCount+"&schoolpage="+SchoolID+bg1+bg2+bg3+"&special="+special+videoID+videoUserCat+videoChannel+downloadCat+tvcatmaster_id+tvvideo_id+tvcat_id+tvchan_id;
		else
	...
	{
		if (testmode)
			frameURL = "https://web.archive.org/web/20070831085731/http://detst.myspace.com/html.ng/site=myspace&position="+pos+"&page="+page+"&rand="+rand+friendID+AdTopicID+"&acnt="+oas_helper.adCount+"&schoolpage="+SchoolID+"&special="+special+videoID+videoUserCat+videoChannel+downloadCat+tvcatmaster_id+tvvideo_id+tvcat_id+tvchan_id;
		else 
...
/*
     FILE ARCHIVED ON 08:57:31 Aug 31, 2007 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:38:40 Jun 02, 2025.
...
playback timings (ms):
  ...
  PetaboxLoader3.datanode: 83.819 (4)
  load_resource: 139.432
  PetaboxLoader3.resolve: 104.992
*/