...
function full(vid){
	var fs = window.open( "https://web.archive.org/web/20071003193601/http://vids.myspace.com/index.cfm?fuseaction=vids.fullscreen&videoid=" + vid,
...
{
	window.open( "https://web.archive.org/web/20071003193601/http://chat.myspace.com/index.cfm?fuseaction=messenger.chatroom&roomID="+roomID, "ICWindow_ChatRoom"+userID+roomID, "status=1,toolbar=0,directories=0,menubar=0,location=0,scrollbars=0,resizable=1,width=800,height=600" );
}

function up_launchChatWithRoom(userID,roomID, subroomID)
{
	window.open( "https://web.archive.org/web/20071003193601/http://chat.myspace.com/index.cfm?fuseaction=messenger.chatroom&roomID="+roomID+"&subroomID="+subroomID, "ICWindow_ChatRoom"+userID+roomID, "status=1,toolbar=0,directories=0,menubar=0,location=0,scrollbars=0,resizable=1,width=800,height=600" );
}
...
{		
	...
	userImage = image;
	if (sender != 1) {
		popupWindowTest = window.open( "https://web.archive.org/web/20071003193601/http://chat.myspace.com/index.cfm?fuseaction=messenger&strDestinationUserID=" + destinationUserID + "&sendType=" + sender, "ICWindow_" + destinationUserID, "status=1,toolbar=0,directories=0,menubar=0,location=0,scrollbars=0,resizable=1,width=500,height=475" );
...
function rsiCheck() {
	...
	document.write(' src="https://web.archive.org/web/20071003193601/http://ads.revsci.net/adserver/rsi_check.js');
	document.write('">');
	document.write('</sc'+'ript>');
}
...
function getIMwin(h,w) {
	var getIMurl = "https://web.archive.org/web/20071003193601/http://www.myspace.com/Modules/IM/Pages/GetIM.aspx";
	var getIMh = h;
	var getIMw = w;
...
var msToolTip = {
	...
	arrowShow	: 0,
	arrowDiv	 : null,
	arrowImgUp   : "https://web.archive.org/web/20071003193601/http://x.myspace.com/images/arrowUp.jpg",
	arrowImgDown : "https://web.archive.org/web/20071003193601/http://x.myspace.com/images/arrowDown.jpg",
	arrowImgLeft : "https://web.archive.org/web/20071003193601/http://x.myspace.com/images/arrowLeft.jpg",
	arrowImgRight: "https://web.archive.org/web/20071003193601/http://x.myspace.com/images/arrowRight.jpg",
...
/*
     FILE ARCHIVED ON 19:36:01 Oct 03, 2007 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:47:56 Jun 02, 2025.
...
playback timings (ms):
  ...
  esindex: 0.011
  cdx.remote: 22.762
  LoadShardBlock: 155.738 (3)
  PetaboxLoader3.datanode: 159.954 (4)
  load_resource: 181.205
  PetaboxLoader3.resolve: 121.299
*/