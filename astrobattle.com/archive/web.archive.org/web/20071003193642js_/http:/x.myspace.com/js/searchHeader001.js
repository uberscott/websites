...
function MySpaceSearchMenu(name)
{
  this.name = name;
	...
	this.currentRow = 0;
	this.maxRowSize = 8;
	this.leftArrowImage = 'https://web.archive.org/web/20071003193608/http://x.myspace.com/images/srch-lf.gif';
	this.rightArrowImage = 'https://web.archive.org/web/20071003193608/http://x.myspace.com/images/srch-rt.gif';
...
/*
     FILE ARCHIVED ON 19:36:08 Oct 03, 2007 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:48:03 Jun 02, 2025.
...
playback timings (ms):
  ...
  esindex: 0.012
  cdx.remote: 177.745
  LoadShardBlock: 76.216 (3)
  PetaboxLoader3.datanode: 554.609 (4)
  load_resource: 679.748
  PetaboxLoader3.resolve: 184.063
*/