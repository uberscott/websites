...
{ this.name = name; this.tabs = new Object(); this.rows = new Array(); this.rows[0] = 0; this.invalidSearchMessage = ''; this.searchBox = null; this.searchButton = null; this.enableWarningMessages = true; this.lastWarningMessage = ''; this.tabOrder = null; this.currentRow = 0; this.maxRowSize = 8; this.leftArrowImage = 'https://web.archive.org/web/20070923024106/http://x.myspace.com/images/srch-lf.gif'; this.rightArrowImage = 'https://web.archive.org/web/20070923024106/http://x.myspace.com/images/srch-rt.gif'; this.Create = MySpaceSearchMenu_CreateMenu; this.CreateMenuRow = MySpaceSearchMenu_CreateMenuRow; this.SetSearchTarget = MySpaceSearchMenu_SetSearchTarget; this.CheckUserInput = MySpaceSearchMenu_CheckUserInput; this.NextRow = MySpaceSearchMenu_DisplayNextRow; this.PrevRow = MySpaceSearchMenu_DisplayPrevRow; this.ShowRow = MySpaceSearchMenu_ShowRow; this.AddTab = MySpaceSearchMenu_AddTab; this.Resize = MySpaceSearchMenu_doResize;}
...
/*
     FILE ARCHIVED ON 02:41:06 Sep 23, 2007 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:52:42 Jun 02, 2025.
...
playback timings (ms):
  ...
  esindex: 0.018
  cdx.remote: 42.824
  LoadShardBlock: 430.132 (3)
  PetaboxLoader3.datanode: 209.135 (4)
  PetaboxLoader3.resolve: 325.501 (2)
  load_resource: 137.459
*/