...
function full(vid)
{
  var fs = window.open( "https://web.archive.org/web/20070923024056/http://vids.myspace.com/index.cfm?fuseaction=vids.fullscreen&videoid=" + vid,
...
function generalizeDomain()
{
                ...
                if (domainArrayLength >= 2 && domainArray[domainArrayLength - 2] != "com") 
...
function oas_ad()
{
	...
	else
	{
	    ...
	    {
	        if(testmode){
    		    document.write("<IFRAME " + pxsize + " style=\"position:relative;z-index:10000\" MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0 SCROLLING=no src='https://web.archive.org/web/20070923024056/http://detst.myspace.com/html.ng/site=myspace&position="+pos+"&page="+page+"&rand="+rand+friendID+AdTopicID+"&acnt="+acnt+"&schoolpage="+SchoolID+"&bandgenre="+document.forms[0].bandgenre1.value+"&bandgenre="+document.forms[0].bandgenre2.value+"&bandgenre="+document.forms[0].bandgenre3.value+"&special="+special+videoID+videoUserCat+videoChannel+downloadCat+"'></iframe>");
    	    }
	        else {
	    ...
	    {
	        if (testmode){
    		    document.write("<IFRAME " + pxsize + " style=\"position:relative;z-index:10000\" MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0 SCROLLING=no src='https://web.archive.org/web/20070923024056/http://detst.myspace.com/html.ng/site=myspace&position="+pos+"&page="+page+"&rand="+rand+friendID+AdTopicID+"&acnt="+acnt+"&schoolpage="+SchoolID+"&special="+special+videoID+videoUserCat+videoChannel+downloadCat+"'></iframe>");
    	    }
	        else {
...
function rsiCheck() {
	...
	document.write(' src="https://web.archive.org/web/20070923024056/http://ads.revsci.net/adserver/rsi_check.js');
	document.write('">');
	document.write('</sc'+'ript>');
}
...
function getIMwin(h,w) {
	var getIMurl = "https://web.archive.org/web/20070923024056/http://www.myspace.com/Modules/IM/Pages/GetIM.aspx";
	var getIMh = h;
	var getIMw = w;
...
var msToolTip = 
{
		...
		arrowShow    : 0,
		arrowDiv     : null,
		arrowImgUp   : "https://web.archive.org/web/20070923024056/http://x.myspace.com/images/arrowUp.jpg", 
		arrowImgDown : "https://web.archive.org/web/20070923024056/http://x.myspace.com/images/arrowDown.jpg",
		arrowImgLeft : "https://web.archive.org/web/20070923024056/http://x.myspace.com/images/arrowLeft.jpg", 
		arrowImgRight: "https://web.archive.org/web/20070923024056/http://x.myspace.com/images/arrowRight.jpg",
...
/*
     FILE ARCHIVED ON 02:40:56 Sep 23, 2007 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:51:40 Jun 02, 2025.
...
playback timings (ms):
  ...
  esindex: 0.012
  cdx.remote: 75.399
  LoadShardBlock: 147.783 (3)
  PetaboxLoader3.datanode: 151.183 (4)
  load_resource: 145.222
  PetaboxLoader3.resolve: 116.285
*/