...
this.init=function(){if(this.host&&this.taxid){if(this.role&&(this.role=="local")){loadScript("catman/code/"+this.host+this.taxid+".js");}else{if(this.role&&((this.role=="deux")||(this.role=="dev"))){loadScript("https://web.archive.org/web/20080522032738/http://scripts.pd.lycos.com/catman/code/"+this.host+this.taxid+".js");}else{if(this.role&&(this.role=="qa")){loadScript("https://web.archive.org/web/20080522032738/http://scripts.qa.lycos.com/catman/code/"+this.host+this.taxid+".js");}else{loadScript("https://web.archive.org/web/20080522032738/http://scripts.lycos.com/catman/code/"+this.host+this.taxid+".js");}}}}};}
new AdManager().init();

}
/*
     FILE ARCHIVED ON 03:27:38 May 22, 2008 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:30:21 Jun 02, 2025.
...
playback timings (ms):
  ...
  esindex: 0.012
  cdx.remote: 44.863
  LoadShardBlock: 425.932 (6)
  PetaboxLoader3.datanode: 242.671 (7)
  PetaboxLoader3.resolve: 322.419 (2)
  load_resource: 310.067
*/