...
Advertiser.SDC.DropPixel = function ()
{
   ...
   if (Advertiser.Login.IsLogin())
   {
      ...
      fimpixel = '<img src="https://web.archive.org/web/20070912150055/http://seg.fimserve.com/relay?';
...
function ad_wrapper()
{
	...
	{
		if(testmode)
			frameURL = "https://web.archive.org/web/20070912150055/http://detst.myspace.com/html.ng/site=myspace&position="+pos+"&page="+page+"&rand="+rand+friendID+AdTopicID+"&acnt="+oas_helper.adCount+"&schoolpage="+SchoolID+bg1+bg2+bg3+"&special="+special+videoID+videoUserCat+videoChannel+downloadCat+tvcatmaster_id+tvvideo_id+tvcat_id+tvchan_id;
		else
	...
	{
		if (testmode)
			frameURL = "https://web.archive.org/web/20070912150055/http://detst.myspace.com/html.ng/site=myspace&position="+pos+"&page="+page+"&rand="+rand+friendID+AdTopicID+"&acnt="+oas_helper.adCount+"&schoolpage="+SchoolID+"&special="+special+videoID+videoUserCat+videoChannel+downloadCat+tvcatmaster_id+tvvideo_id+tvcat_id+tvchan_id;
		else 
...
/*
     FILE ARCHIVED ON 15:00:55 Sep 12, 2007 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 19:01:40 Jun 02, 2025.
...
playback timings (ms):
  ...
  esindex: 0.011
  cdx.remote: 12.29
  LoadShardBlock: 1386.111 (3)
  PetaboxLoader3.datanode: 1455.567 (4)
  load_resource: 168.927
  PetaboxLoader3.resolve: 67.807
*/